export const SAMPLE_SINGLE = {
  ...
  artObject: {
    ...
    colors: [
      ...
      { percentage: 9, hex: " #5E3C14" },
      { percentage: 3, hex: " #9C8238" },
      { percentage: 2, hex: " #885617" },
      { percentage: 1, hex: " #AF9F6B" },
      { percentage: 0, hex: " #6C6238" },
      { percentage: 0, hex: " #D7CB9E" },
    ],
    colorsWithNormalization: [
      { originalHex: "#261808", normalizedHex: "#000000" },
      { originalHex: " #5E3C14", normalizedHex: "#B35A1F" },
      { originalHex: " #9C8238", normalizedHex: "#E09714" },
      { originalHex: " #885617", normalizedHex: "#B35A1F" },
      { originalHex: " #AF9F6B", normalizedHex: "#E0CC91" },
      { originalHex: " #6C6238", normalizedHex: "#367614" },
      { originalHex: " #D7CB9E", normalizedHex: "#E0CC91" },
    ],
    normalizedColors: [
      { percentage: 81, hex: "#000000" },
      { percentage: 12, hex: " #8B4513" },
      { percentage: 3, hex: " #B8860B" },
      { percentage: 1, hex: " #BDB76B" },
      { percentage: 0, hex: " #556B2F" },
      { percentage: 0, hex: " #F5DEB3" },
    ],
    normalized32Colors: [
      { percentage: 81, hex: "#000000" },
      { percentage: 12, hex: " #B35A1F" },
      { percentage: 3, hex: " #E09714" },
      { percentage: 2, hex: " #E0CC91" },
      { percentage: 0, hex: " #367614" },
    ],
    materialsThesaurus: [],
    techniquesThesaurus: [],
    ...
    principalMakers: [
      {
        ...
        qualification: null,
        labelDesc: "Rembrandt van Rijn (15-jul-1606 - 08-okt-1669), Amsterdam",
      },
    ],
    ...
    dimensions: [
      ...
      { unit: "kg", type: "weight", precision: null, part: null, value: "337" },
      { unit: "kg", type: "weight", precision: null, part: null, value: "170" },
    ],
    physicalProperties: [],
