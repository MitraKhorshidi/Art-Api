  ...
  return (
    <div className="flex flex-col justify-center gap-8">
      {webImage && (
        ...
        >
          <h1 className="absolute left-[2%] bottom-[4%] w-[90%] aspect-[1043/64] text-2xl sm:text-[56px] leading-8 sm:leading-[64px] text-primary shadow-[0px_4px_4px_0px_rgba(0, 0, 0, 0.06)]">
            {longTitle}
          </h1>
        </div>
      )}
      <div className="flex flex-col justify-start p-[10px] gap-[10px]">
        {longTitle && (
          <div className="gap-1 pt-2 pb-4 text-secondary border-b-[1px] border-b-secondary">
            ...
            <h3 className="text-lg sm:text-2xl text-primary leading-8 ">{longTitle}</h3>
          </div>
        )}
        ...
        {principalMaker && (
          <div className="gap-1 pt-2 pb-4 text-secondary border-b-[1px] border-b-secondary">
            ...
            <h3 className="text-lg sm:text-2xl text-primary leading-8 ">{principalMaker}</h3>
          </div>
        )}
        ...
        {objectTypes && (
          <div className="gap-1 pt-2 pb-4 text-secondary border-b-[1px] border-b-secondary">
            ...
            <h3 className="text-lg sm:text-2xl text-primary leading-8 ">{objectTypes}</h3>
          </div>
        )}
        ...
        {dimensions.length > 0 && (
          <div className="gap-1 pt-2 pb-4 text-secondary border-b-[1px] border-b-secondary">
            ...
            <h3 className="text-lg sm:text-2xl text-primary leading-8 ">
              {dimensions.map((obj) => (
                <span key={obj.type}>
                  {" "}
        ...
        {description && (
          <div className="gap-1 pt-2 pb-4 text-secondary border-b-[1px] border-b-secondary">
            ...
            <h3 className="text-lg sm:text-2xl text-primary leading-8 ">{description}</h3>
          </div>
        )}
      </div>
    </div>
